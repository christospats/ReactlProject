    ...
    return ( 
        <FlexboxGrid>
            <Container style={{marginTop:'56px',position:'static',width:'100%',height:'100vh'}}>
                ...
                >
                    <h3 style={{textAlign:'center'}}>Το φροντιστήριό μας</h3>
                    ...
                    χώρος αυτός αποτελεί «δεύτερο» ή και κανονικό σπίτι !<br/><br/>
                    ...
                    δεδομένου ότι η πορεία προς τις εξετάσεις αποβαίνει συχνά ψυχοφθόρα.<br/><br/>
